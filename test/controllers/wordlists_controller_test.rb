...
class WordlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wordlist" do
    assert_difference('Wordlist.count') do
      post wordlists_url, params: { wordlist: { category_id: @wordlist.category_id, language: @wordlist.language, translate_language: @wordlist.translate_language } }
    end
  ...
  test "should update wordlist" do
    patch wordlist_url(@wordlist), params: { wordlist: { category_id: @wordlist.category_id, language: @wordlist.language, translate_language: @wordlist.translate_language } }
